...
public class j4 {
    public static void main(String[] args) {
        ...
        products[0] = new product(785432, 199);
        products[1] = new product(845753, 79);
        products[2] = new product(264535, 999);
        products[3] = new product(454121, 749);
        products[4] = new product(121312, 149);
